...
const initialState = {
  ...
  programISAFundingAmount: isaProgramFundingAmount(defaultFormInputs.startDate, defaultFormInputs.exitDate),
  ...
  switch (action.type) {
    case actionTypes.RECALCULATE: {
      ...
      const newState = {
        ...
        programISAFundingAmount: isaProgramFundingAmount(startDate, exitDate),
