      ...
      <Card style={cardStyle()}>
        ...
        <CardText>
          ...
          <Input
            theme={inputTheme}
            icon="attach_money"
            label="Pay it Forward ISA Funding Amount"
            value={formatMoney(programISAFundingAmount)}
            disabled
          />
          <Input
            theme={inputTheme}
...
Calculations.propTypes = {
  ...
  programISAFundingAmount: PropTypes.number.isRequired,
